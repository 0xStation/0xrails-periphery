...
contract EarlyDoors is Script {
    ...
    // is this membership on mainnet the up to date version?
    ...
    function run() public {
        ...
        // purchase module
        FixedStablecoinPurchaseModule purchaseModule = new FixedStablecoinPurchaseModule(owner, 0.001 ether, "USD", decimals);
        purchaseModule.append(fakeToken);
