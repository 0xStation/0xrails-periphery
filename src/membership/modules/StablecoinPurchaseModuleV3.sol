...
contract StablecoinPurchaseModuleV3 is ModuleFee, ModuleSetup, ModuleGrant {
    ...
    function setUp(uint128 price, address[] memory enabledCoins, bool enforceGrants) public {
