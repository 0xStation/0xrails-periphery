...
contract GasCoinPurchaseModuleV3 is ModuleGrant, ModuleFee, ModuleSetup {
    /*=============
        STORAGE
    =============*/
    ...
    function setUp(uint256 price, bool enforceGrants) public {
        setUp(msg.sender, price, enforceGrants);
    }

    function setUp(address collection, uint256 price, bool enforceGrants) public canSetUp(collection) {
