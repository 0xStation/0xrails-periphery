...
// fork of OZ ERC20, but with `internal` variables instead of `private`
...
contract FakeERC20 is ERC20 {
    ...
    function _transferFromNoRevert(address from, address to, uint256 amount) internal returns (bool) {
        address spender = _msgSender();
